...
\n\<input class='uk-input' type='text' placeholder='First Name' name='conFirstName" + count +"'>\n\
\n\</div>\n\
\n\</div>\n\
\n\<br>\n\
...
\n\<div class='uk-form-controls'>\n\
\n\<input class='uk-input' type='text' placeholder='Last Name' name='conLastName" + count + "'>\n\
\n\</div>\n\
\n\</div>\n\
\n\<br>\n\
\n\<div class='uk-width-1-2@s'>\n\
